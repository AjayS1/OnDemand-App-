...
- (void)sendCreditCardDataApiCall {
    ...
    if (_signatureImageView.image) {
        ...
        [ProgressHUD show:@"Please wait..." Interaction:NO];
        [ServerRequest AFNetworkPostRequestUrlForAddNewApiForQA:APIAddCreditCard withParams:params CallBack:^(id responseObject, NSError *error) {
