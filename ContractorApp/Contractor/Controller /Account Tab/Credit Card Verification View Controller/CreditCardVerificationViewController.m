...
-(void)callPaynowCreditCardVerificationAPI{
    ...
    NSString *urlstr=[NSString stringWithFormat:@"%@?userID=%@&cardNumber=%@&authenticationAmount=%@&VerifyID=%@&PastDue=%@&IsPrimary=%@&Dateid=%@DateType=%@",APIPaynowCreditCardVerify,userIdStr,self.accountNumberStr,_amount.text,self.accountKeyStr,self.pastDueString,self.primaryStringValue,self.dateIdStringValue,@"2"];
