...
- (void) loadContent {
    ...
    if (!_label || !_slider) {
        ...
        UIImage *thumbImage = [self thumbWithColor:[UIColor redColor]];
...
- (void)layoutSubviews {
    ...
    if (WIN_WIDTH == 414) {
        _label.frame = CGRectMake(sliderWidth - 0.0,
                                  CGRectGetMidY(self.bounds) - (labelSize.height / 2.0),
                                  CGRectGetWidth(self.bounds) - sliderWidth - 2.0,
                                  labelSize.height
                                  );
    }
    else {
        _label.frame = CGRectMake(sliderWidth - 25.0,
                                  CGRectGetMidY(self.bounds) - (labelSize.height / 2.0),
                                  CGRectGetWidth(self.bounds) - sliderWidth - 2.0,
                                  labelSize.height
                                  );
...
- (UIImage *) thumbWithColor:(UIColor*)color {
    ...
    // Arrow
    [[[UIColor clearColor] colorWithAlphaComponent:0.6] setFill];
    [[[UIColor clearColor] colorWithAlphaComponent:0.0] setStroke];
    ...
    UIImage *outputImage = [UIImage imageNamed:@"slidetounlock_thumb@1x.png"];
    //write (debug)
...
- (void)drawLayer:(CALayer *)theLayer inContext:(CGContextRef)theContext
{
    ...
    CGContextSelectFont(theContext, [[NSString stringWithFormat:@"%@",@"Helvetica"] UTF8String], self.font.pointSize, kCGEncodingMacRoman);
