...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
       ...
       // [self.topLeftCornerView setBackgroundColor:[UIColor whiteColor]];
       ...
       // [self.topRightCornerView setBackgroundColor:[UIColor whiteColor]];
       ...
       // [self.bottomLeftCornerView setBackgroundColor:[UIColor whiteColor]];
     ...
     //   [self.bottomRightCornerView setBackgroundColor:[UIColor whiteColor]];
