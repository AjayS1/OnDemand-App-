...
- (void)loadView
{
    ...
    contentView.backgroundColor = [UIColor colorWithRed:239.0/255.0 green:239.0/255.0 blue:239.0/255.0 alpha:1.0];
    self.view = contentView;
    NSLog(@"Crop Rect Width %f", APPDELEGATE.controllerCropRect.size.width);
    NSLog(@"Crop Rect Height %f", APPDELEGATE.controllerCropRect.size.height);

    self.cropView.controllerCropRect = APPDELEGATE.controllerCropRect;
