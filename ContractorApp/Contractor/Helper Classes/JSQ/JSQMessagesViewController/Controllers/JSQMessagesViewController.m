...
- (void)finishSendingMessageAnimated:(BOOL)animated {
    ...
    /*
    msg list = http://ondemandapi.flexsin.in/API/Account/GetAllMessage?userID=Cu00e2618&UserType=2
    
    msg detail = http://ondemandapi.flexsin.in/API/Account/GetMessagebyUser?CustomerID=Cu009fe53&ContractorID=Cu00e2618&UserType=2
    
    msg send = http://ondemandapi.flexsin.in/API/Account/SendMessage?CustomerID=Cu009fe53&ContractorID=Cu00e2618&Message=test&UserType=2
   */
  ...
  //  NSString *userIdStr = [[NSUserDefaults standardUserDefaults]objectForKey:@"USERIDDATA"];
    ...
    if ([sharedInstance.recipientIdStr length]) {
        ...
        NSString *urlstr=[NSString stringWithFormat:@"%@?CustomerID=%@&ContractorID=%@&Message=%@&UserType=%@&date=%@",APISendMessage,sharedInstance.recipientIdStr,userIdStr,messageStr,@"2",sharedInstance.dateIdStr];
        ...
        [ServerRequest AFNetworkPostRequestUrl:encodedUrl withParams:nil CallBack:^(id responseObject, NSError *error) {
            ...
            if(!error){
                ...
                if ([[responseObject objectForKey:@"StatusCode"] intValue] ==1) {
                    ...
                    sharedInstance.checkChateIsActive = YES;
...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (sharedInstance.isFromMessageDetails) {
        ...
        NSLog(@"Cell Bottom  DateText %@",dateTextValue);
