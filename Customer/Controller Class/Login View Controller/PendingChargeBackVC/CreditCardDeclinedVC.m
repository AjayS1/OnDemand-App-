...
-(void)tryAgainBankAccountMethode{
    {
        if ([_bankDetailsWithUrl length]) {
            ...
            [ServerRequest AFNetworkPostRequestUrlForAddNewApi:_bankDetailsWithUrl withParams:nil CallBack:^(id responseObject, NSError *error) {
                ...
                if(!error){
                    ...
                    if ([[responseObject objectForKey:@"StatusCode"] intValue] ==1) {
                        if (self.isFromCaneclDateByCustomer) {
